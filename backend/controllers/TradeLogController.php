...
class TradeLogController extends \yii\web\Controller
{
    public function actionIndex()
    {
        ...
        //总数据条数
        $statisticsSql = "SELECT ID FROM lami_deal.log_deal $whereContidion";
        ...
        $statisticsSql = "SELECT * FROM lami_deal.log_deal $whereContidion Order BY UpdateTime DESC LIMIT 50 OFFSET $offset";
