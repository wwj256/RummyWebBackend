...
//    'ServerURL' => 'http://15.206.188.191:6011/',
   'domain' => 'http://loalhost:8080/shopres/',
    ...
    'imageUploadRelativePath2' => 'C:/work/src/shopres/guide/', // 导师资源图片上传的目录
    'imageUploadSuccessPath2' => '/guide/', // 导师图片上传成功后，路径前缀
    'imageUploadRelativePath3' => 'C:/work/src/shopres/recommend/', // 推荐图片默认上传的目录
    'imageUploadSuccessPath3' => '/recommend/', // 图片上传成功后，路径前缀
    'imageUploadRelativePath4' => 'C:/work/src/shopres/notice/', // 公告图片默认上传的目录
    'imageUploadSuccessPath4' => '/notice/', // 图片上传成功后，路径前缀
    'imageUploadRelativePath5' => 'C:/work/src/shopres/video/', // 视频默认上传的目录
    'imageUploadSuccessPath5' => '/video/', // 视频上传成功后，路径前缀
    'imageUploadRelativePath6' => 'C:/work/src/shopres/meeting/', // 会议默认上传的目录
    'imageUploadSuccessPath6' => '/meeting/', // 会议上传成功后，路径前缀
    'imageUploadRelativePath7' => 'C:/work/src/shopres/card/', // 用户头像默认上传的目录
    'imageUploadSuccessPath7' => '/card/', // 用户头像上传成功后，路径前缀
    'imageUploadRelativePath8' => 'C:/work/src/shopres/case/', // 落地方案默认上传的目录
    'imageUploadSuccessPath8' => '/case/', // 落地方案路径前缀
