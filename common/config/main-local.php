...
return [
    'components' => [
        ...
        'db' => [
           'class' => 'yii\db\Connection',
           'dsn' => 'mysql:host=65.2.55.14;dbname=lami_backend',
           'username' => 'root',
           'password' => 'lami_baaddb',
           'charset' => 'utf8',
       ],
       'db2' => [
           'class' => 'yii\db\Connection',
           'dsn' => 'mysql:host=65.2.55.14;dbname=lami_account',
           'username' => 'root',
           'password' => 'lami_baaddb',
           'charset' => 'utf8',
       ],
       'db3' => [
           'class' => 'yii\db\Connection',
           'dsn' => 'mysql:host=65.2.55.14;dbname=lami_platform',
           'username' => 'root',
           'password' => 'lami_baaddb',
           'charset' => 'utf8',
       ],
       'db4' => [
           'class' => 'yii\db\Connection',
           'dsn' => 'mysql:host=65.2.55.14;dbname=lami_record',
           'username' => 'root',
           'password' => 'lami_baaddb',
           'charset' => 'utf8',
       ],
       'db5' => [
            'class' => 'yii\db\Connection',
            'dsn' => 'mysql:host=65.2.55.14;dbname=lami_deal',
            'username' => 'root',
            'password' => 'lami_baaddb',
            'charset' => 'utf8',
        ],
